...
import { n as auth } from "./server-05Z7jrV3.mjs";
import { i as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cf55EAsp.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-svh flex-col items-center justify-center gap-3 bg-bg px-6 text-center text-fg",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "发生了未知错误，请刷新后重试。"
			})
		]
	});
}
...
var styles_default = "/assets/styles-BYn_86XQ.css";
var APP_NAME = "Trading糕手";
...
var Route$6 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "黄金实盘交易会员 · 中文社群与一对一私教 · 法国出身，现居中国 · 全年仅二十席"
			},
			{
				name: "theme-color",
				content: "#0c0b09"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
				theme: "dark",
				position: "top-center",
				toastOptions: { classNames: { toast: "bg-surface text-fg border-border shadow-border" } }
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	})
});
var $$splitComponentImporter$4 = () => import("./routes-DLySZNmF.mjs");
var Route$5 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./account-DUm5oWUl.mjs");
var Route$4 = createFileRoute("/account")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./admin-D3oPZVkw.mjs");
var Route$3 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./apply-DOD25bq9.mjs");
var Route$2 = createFileRoute("/apply")({
	validateSearch: (search) => ({ plan: typeof search.plan === "string" ? search.plan : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./login-5Ax07k7_.mjs");
var Route$1 = createFileRoute("/login")({
	validateSearch: (search) => ({ next: typeof search.next === "string" && search.next.startsWith("/") ? search.next : void 0 }),
